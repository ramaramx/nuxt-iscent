...
<section class="bg-hero-contact">
  <div class="py-8 px-5 lg:py-16 lg:pl-44 lg:px-0 mx-auto max-w-screen-md">
      <h2 class="mb-4 text-4xl tracking-tight font-extrabold lg:text-right text-center text-black">Contact Us</h2>
      <p class="mb-8 lg:mb-16 font-medium lg:text-right text-center text-gray-500 sm:text-xl">Got a technical issue? Want to send feedback about a beta feature? Need details about our Business plan? Let us know.</p>
      <form action="#" class="space-y-8">
          ...
          <button type="submit" class="flex justify-center py-3 px-5 text-sm font-medium lg:text-right text-center text-black rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 ">Send message</button>
      </form>
  </div>
</section>
</template>
